...
// ProcessingJob mocks base method.
func (m *MockServiceMethod) ProcessingJob(ctx context.Context, rjob []models.RequestJob) ([]models.NewRequestJob, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ProcessingJob", ctx, rjob)
	ret0, _ := ret[0].([]models.NewRequestJob)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// ProcessingJob indicates an expected call of ProcessingJob.
func (mr *MockServiceMethodMockRecorder) ProcessingJob(ctx, rjob any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ProcessingJob", reflect.TypeOf((*MockServiceMethod)(nil).ProcessingJob), ctx, rjob)
}
